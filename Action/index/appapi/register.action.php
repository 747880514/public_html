...
class registerAction extends Action{
	...
	public function doing(){
		...
		$set=zfun::f_getset("jf_reg,commission_reg");
		...
		if (!empty($_POST['type'])) {
			...
			switch($_POST['type']) {
				...
				case 1 :
					...
					$userdata = array('phone' => $_POST['username'], 'nickname' => $_POST['username'], 'password' => $_POST['pwd'], 'integral' => $jf_reg, 'reg_time' => time(),"commission"=>$commission_reg, 'token' => $token);
				...
				case 2 :
					...
					$userdata = array('email' => $_POST['username'], 'nickname' => $arr[0], 'password' => $_POST['pwd'], 'integral' => $jf_reg, 'reg_time' => time(),"commission"=>$commission_reg, 'token' => $token);
	...
	public function threelogin() {
		...
		$set=zfun::f_getset("jf_reg,commission_reg,blocking_price_endday");	//百里，追加blocking_price_endday
